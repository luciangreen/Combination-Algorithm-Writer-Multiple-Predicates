cawptest2(1.5,add0,[[[n,+],2,1%% Modes=2 inputs, 1 output
...
(Program2=[[[n,1],[[v,a],[v,b],[v,c]],":-",[[[n,+],[[v,a],[v,d]]],[[n,=],[[v,d],[v,c]]]]]]->
	trace
	;true),
...
%%(Program2=[[[n,1],[[v,a],[v,b],[v,c]],":-",[[[n,+],[[v,a],[v,b],[v,d]]],[[n,=],[[v,d],[v,c]]]]],[[n,add0],[[v,a],[v,b],[v,c]],":-",[[[n,1],[[v,a],[v,b],[v,d]]],[[n,=],[[v,d],[v,c]]]]]]->trace
%%;true),
...
%%writeln([rule(RuleName,NumInputs,NumOutputs,VarList,VarList2,Rule)]),
	...
	not(RuleName0=predicatename_new_branch),not(RuleName0=other_new_branch),not(RuleName0=[rules_new_branch,_]),
		%%trace,
(RuleName0=[_,RuleName1]->RuleName2=RuleName1;RuleName2=RuleName0),
...
)->true;(RuleName0=[rules_new_branch,RuleName], %% New branch with same name as current predicate
%%trace,
...
%%writeln(rule(Program1,RuleName,InModes,OutModes,InputVars1,InputVars2,VarList,VarList2,OutputVars,Rule)),

rule1(RuleName,InModes,OutModes,InputVars1,InputVars2,VarList,VarList2,OutputVars,Rule1),
((1 is InModes+OutModes,member(Rule1,Program1))->(InputVars1=[_|InputVars3],rule(Program1,RuleName,InModes,OutModes,InputVars3,InputVars2,VarList,VarList2,OutputVars,Rule2),Rule=Rule2);(InputVars1=InputVars3,Rule=Rule1))
...
get_members(InModes1,InputVars,Vars1,Vars2) :-
	...
	%%get_members(InModes1,InputVars,Vars3,Vars2). %%InModes2->1
